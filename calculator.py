...
#Button(root,text="=",width=5,height=3,font=("arial",30,'bold'),bd=1,fg="#fff",bg="yellow",command=lambda: show("=")).place(x=430,y=400)

Button(root,text="=",width=5,height=3,font=("arial",30,'bold'),bd=1,fg="#fff",bg="yellow",command=lambda: calculate()).place(x=430,y=400)
